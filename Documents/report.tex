...
\newcommand{\screenshotwidth}{0.34\textwidth}

\begin{figure}[H]
    \centering
    \begin{minipage}{\screenshotwidth}
        \centering
        \includegraphics[width=\textwidth]{PhotosApplication/connexionInscription.jpg}
        \caption{Login and registration screen.}
        \label{fig:screenshot-auth}
    \end{minipage}
    \hfill
    \begin{minipage}{\screenshotwidth}
        \centering
        \includegraphics[width=\textwidth]{PhotosApplication/home.jpg}
        \caption{Home screen.}
...
\begin{figure}[H]
    ...
    \begin{minipage}{\screenshotwidth}
        \centering
        \includegraphics[width=\textwidth]{PhotosApplication/groups.jpg}
        \caption{Groups screen.}
        \label{fig:screenshot-groups}
    \end{minipage}
    \hfill
    \begin{minipage}{\screenshotwidth}
        \centering
        \includegraphics[width=\textwidth]{PhotosApplication/CreerGroupe.jpg}
        \caption{Group creation and friends selection screen.}
        \label{fig:screenshot-create-group}
    \end{minipage}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{minipage}{\screenshotwidth}
        \centering
        \includegraphics[width=\textwidth]{PhotosApplication/profileavantmaj.jpg}
        \caption{Profile screen before update.}
        \label{fig:screenshot-profile-before}
    \end{minipage}
    \hfill
    \begin{minipage}{\screenshotwidth}
        \centering
        \includegraphics[width=\textwidth]{PhotosApplication/Profilemaj.jpg}
        \caption{Profile screen after update.}
        \label{fig:screenshot-profile-after}
    \end{minipage}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\screenshotwidth]{PhotosApplication/majmotdepasse.jpg}
    \caption{Password update screen.}
    \label{fig:screenshot-password-update}
\end{figure}
