...
\begin{figure}[H]
    ...
    \hfill
    \screenshottile{PhotosApplication/shimmerloadingeffect.jpeg}{Shimmer loading effect (Home Screen)}
    \hfill
    \screenshottile{PhotosApplication/home.jpeg}{Home}
    \hfill
    \\[0.5cm]
    \screenshottile{PhotosApplication/groups.jpeg}{Groups}
    \hfill
    \screenshottile{PhotosApplication/creategroup.jpeg}{Group creation}
    \hfill
    \screenshottile{PhotosApplication/friends.jpeg}{Friends screen}
    \hfill
    \\[0.5cm]
...
\begin{figure}[H]\ContinuedFloat
    \centering
    \\[1cm]
    \screenshottile{PhotosApplication/configgame.jpeg}{Game configuration}
    \hfill
    \screenshottile{PhotosApplication/activeround.jpeg}{Active round}
    \hfill
    \screenshottile{PhotosApplication/imagetobeguessed.jpeg}{Picture screen}
    \\[1cm]

    \screenshottile{PhotosApplication/makeguess.jpeg}{Guess location}
    \hfill
    \screenshottile{PhotosApplication/viewtruelocation.jpeg}{Real location revealed}
    \hfill
    \screenshottile{PhotosApplication/finishedgame.jpeg}{Finished game screen}
